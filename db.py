...
class DBSCANSegmenter(DefineParams):
    def __init__(self, file_name,image, eps=0.5, min_samples=5):
        self.image = image
    ...
    def segment_algo(self):        
        ...
        dbscan = DBSCAN(eps=float(self.eps), min_samples=int(self.min_samples))
    ...
    def color_image(self, image):
        img = self.file_name[0] + "_dbscan." + self.file_name[1]
