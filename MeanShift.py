...
class MeanShiftSegmenter(DefineParams):
    def __init__(self, file_name,image, bandwidth=0.1):
        self.image = image
    ...
    def segment_algo(self):
        ...
        meanshift_model = MeanShift(bandwidth=float(self.bandwidth), bin_seeding=True)
    ...
    def color_image(self, image):
        img = self.file_name[0] + "_mean_shift." + self.file_name[1]
